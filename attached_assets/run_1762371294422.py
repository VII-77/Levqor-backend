...
# --- In-memory job store (swap to your persistent store later) ---
JOBS = {}
...
def intake():
    ...
    # TODO: enqueue into your real orchestrator here
    # e.g., put on an internal queue; return 202 Accepted
...
# --- Dev util: simulate completion (remove in prod) ---
